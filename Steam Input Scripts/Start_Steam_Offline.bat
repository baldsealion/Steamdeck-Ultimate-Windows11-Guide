...
xcopy "C:\Users\Steamdeck\Documents\Steamdeck Important Stuff\Offline Mode\Modified" "C:\Program Files (x86)\Steam\config" /i /e /y

SET command="C:\Program Files (x86)\Steam\Steam.exe" -noverifyfiles -nobootstrapupdate -skipinitialbootstrap -silent
START "" %command%
